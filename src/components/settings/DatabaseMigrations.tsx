    ...
    try {
      ...
      if (success) {
        ...
        toast({
          ...
          description: "Account isolation features have been successfully implemented.",
          variant: "default"
        });
      }
    } catch (error) {
      ...
      toast({
        ...
        description: "Failed to apply account isolation migration. See console for details.",
        variant: "destructive"
      });
    } finally {
      setIsApplying(false);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Apply database migrations to enhance your SmartEstate platform
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        <Alert>
          ...
          <AlertDescription>
            These operations require administrator privileges and will modify your database structure.
